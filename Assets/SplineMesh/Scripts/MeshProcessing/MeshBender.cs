...
namespace SplineMesh {
    ...
    public class MeshBender : MonoBehaviour {
        ...
        private  void Compute() {
            isDirty = false;
            // Ohne lesbares Quell-Mesh gibt es nichts zu biegen. Ohne diese Sperre wuerde
            // FillRepeat() durch source.Length == 0 teilen. Die Ursache meldet SourceMesh.BuildData().
            if (source.Mesh == null || source.Mesh.vertexCount == 0) return;
            switch (Mode) {
